...
// Source: pkg/protos/pitaya_grpc.pb.go
...
func (m *MockUnsafePitayaServer) mustEmbedUnimplementedPitayaServer() {
	m.ctrl.T.Helper()
...
func (mr *MockUnsafePitayaServerMockRecorder) mustEmbedUnimplementedPitayaServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedPitayaServer", reflect.TypeOf((*MockUnsafePitayaServer)(nil).mustEmbedUnimplementedPitayaServer))
}
