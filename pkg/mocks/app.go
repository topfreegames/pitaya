...
// Source: github.com/topfreegames/pitaya/v2/pkg (interfaces: Pitaya)
...
import (
	...
	component "github.com/topfreegames/pitaya/v2/pkg/component"
	config "github.com/topfreegames/pitaya/v2/pkg/config"
	interfaces "github.com/topfreegames/pitaya/v2/pkg/interfaces"
	metrics "github.com/topfreegames/pitaya/v2/pkg/metrics"
	protos "github.com/topfreegames/pitaya/v2/pkg/protos"
	router "github.com/topfreegames/pitaya/v2/pkg/router"
	session "github.com/topfreegames/pitaya/v2/pkg/session"
	worker "github.com/topfreegames/pitaya/v2/pkg/worker"
...
// RawRPC mocks base method.
func (m *MockPitaya) RawRPC(arg0 context.Context, arg1, arg2 string, arg3 []byte) (*protos.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RawRPC", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*protos.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RawRPC indicates an expected call of RawRPC.
func (mr *MockPitayaMockRecorder) RawRPC(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RawRPC", reflect.TypeOf((*MockPitaya)(nil).RawRPC), arg0, arg1, arg2, arg3)
}
