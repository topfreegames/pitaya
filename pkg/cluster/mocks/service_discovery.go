...
func (m *MockServiceDiscovery) AddListener(listener cluster2.SDListener) {
	m.ctrl.T.Helper()
...
func (m *MockServiceDiscovery) GetServer(id string) (*cluster2.Server, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServer", id)
	ret0, _ := ret[0].(*cluster2.Server)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockServiceDiscovery) GetServers() []*cluster2.Server {
	m.ctrl.T.Helper()
...
func (m *MockServiceDiscovery) GetServersByType(serverType string) (map[string]*cluster2.Server, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServersByType", serverType)
	ret0, _ := ret[0].(map[string]*cluster2.Server)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
