...
func (m *MockReporter) ReportEvent(title, text string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReportEvent", title, text)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockReporterMockRecorder) ReportEvent(title, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReportEvent", reflect.TypeOf((*MockReporter)(nil).ReportEvent), title, text)
}
