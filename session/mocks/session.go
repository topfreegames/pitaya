...
func (m *MockNetworkEntity) ResponseMID(mid uint, v interface{}) error {
	ret := m.ctrl.Call(m, "ResponseMID", mid, v)
	ret0, _ := ret[0].(error)
	return ret0
}

// ResponseMID indicates an expected call of ResponseMID
func (mr *MockNetworkEntityMockRecorder) ResponseMID(mid, v interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResponseMID", reflect.TypeOf((*MockNetworkEntity)(nil).ResponseMID), mid, v)
}
...
func (m *MockNetworkEntity) SendRequest(serverID, route string, v interface{}) (*protos.Response, error) {
	ret := m.ctrl.Call(m, "SendRequest", serverID, route, v)
...
func (mr *MockNetworkEntityMockRecorder) SendRequest(serverID, route, v interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendRequest", reflect.TypeOf((*MockNetworkEntity)(nil).SendRequest), serverID, route, v)
}
