...
func (m *MockNetworkEntity) ResponseMID(mid uint, v interface{}, isError ...bool) error {
	varargs := []interface{}{mid, v}
...
func (mr *MockNetworkEntityMockRecorder) ResponseMID(mid, v interface{}, isError ...interface{}) *gomock.Call {
	varargs := append([]interface{}{mid, v}, isError...)
