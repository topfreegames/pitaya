...
func (m *ProtoDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Desc) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintProtodescriptor(dAtA, i, uint64(len(m.Desc)))
...
func (m *ProtoName) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintProtodescriptor(dAtA, i, uint64(len(m.Name)))
		i += copy(dAtA[i:], m.Name)
	}
	return i, nil
}

func (m *ProtoDescriptors) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProtoDescriptors) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Desc) > 0 {
		for _, b := range m.Desc {
			dAtA[i] = 0xa
			i++
			i = encodeVarintProtodescriptor(dAtA, i, uint64(len(b)))
			i += copy(dAtA[i:], b)
		}
	}
	return i, nil
...
func (m *ProtoNames) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProtoNames) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ProtoDescriptor) Size() (n int) {
	...
	l = len(m.Desc)
	if l > 0 {
		n += 1 + l + sovProtodescriptor(uint64(l))
	}
	return n
}
...
func (m *ProtoDescriptors) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProtoDescriptors) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProtoDescriptors: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProtoDescriptors: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Desc = append(m.Desc, make([]byte, postIndex-iNdEx))
			copy(m.Desc[len(m.Desc)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProtodescriptor(dAtA[iNdEx:])
...
func (m *ProtoNames) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProtoNames: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProtoNames: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 3:
			for {
				...
				next, err := skipProtodescriptor(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
