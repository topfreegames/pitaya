...
func (m *TestResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Code != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintTestresponse(dAtA, i, uint64(m.Code))
	}
	if len(m.Msg) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTestresponse(dAtA, i, uint64(len(m.Msg)))
		i += copy(dAtA[i:], m.Msg)
	}
	return i, nil
}

func encodeVarintTestresponse(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *TestResponse) Size() (n int) {
	...
	_ = l
	if m.Code != 0 {
		n += 1 + sovTestresponse(uint64(m.Code))
	}
	l = len(m.Msg)
	if l > 0 {
		n += 1 + l + sovTestresponse(uint64(l))
	}
	return n
}

func sovTestresponse(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozTestresponse(x uint64) (n int) {
	return sovTestresponse(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *TestResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowTestresponse
			}
			if iNdEx >= l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipTestresponse(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipTestresponse(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowTestresponse
			}
			if iNdEx >= l {
		...
		case 3:
			for {
				...
				next, err := skipTestresponse(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var fileDescriptor_testresponse_54fc8a606ea520b4 = []byte{
	...
	0x2e, 0xe6, 0xdc, 0xe2, 0x74, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x10, 0xd3, 0x49, 0xe0,
	0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e,
	0x21, 0x89, 0x0d, 0x6c, 0xa8, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xec, 0x5e, 0x4c, 0x82, 0x6a,
	0x00, 0x00, 0x00,
}
