...
func (*SomeStruct) Descriptor() ([]byte, []int) { return fileDescriptorSomestruct, []int{0} }
...
func init() { proto.RegisterFile("somestruct.proto", fileDescriptorSomestruct) }

var fileDescriptorSomestruct = []byte{
