...
func (m *MockRPCClient) Post(ctx context.Context, rpcType protos.RPCType, route *route.Route, session *session.Session, msg *message.Message, server *cluster.Server) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Post", ctx, rpcType, route, session, msg, server)
	ret0, _ := ret[0].(error)
	return ret0
}

// Post indicates an expected call of Post
func (mr *MockRPCClientMockRecorder) Post(ctx, rpcType, route, session, msg, server interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Post", reflect.TypeOf((*MockRPCClient)(nil).Post), ctx, rpcType, route, session, msg, server)
}
